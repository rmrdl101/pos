...
<html>
    <head>
        ...
        <!--[if lt IE 9]>
        <script src="{{ asset('storage/') }}https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js"></script>
        <script src="{{ asset('storage/') }}https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
        <![endif]-->
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            <!-- Logo -->
            <a href="{{ asset('storage/index2.html') }}" class="logo">
                <!-- mini logo for sidebar mini 50x50 pixels -->
                <span class="logo-mini"><b>P</b>OS</span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>Point</b>OfSale</span>
            </a>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2014-2019 <a href="{{ asset('storage/') }}https://adminlte.io">AdminLTE</a>.</strong> All rights
            reserved.
        </footer>
        ...
        <aside class="control-sidebar control-sidebar-dark" style="display: none;">
            ...
            <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
                <li><a href="{{ asset('storage/') }}#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
                <li><a href="{{ asset('storage/') }}#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
            </ul>
            <!-- Tab panes -->
            <div class="tab-content">
                ...
                <div class="tab-pane" id="control-sidebar-home-tab">
                    ...
                    <ul class="control-sidebar-menu">
                        <li>
                            <a href="{{ asset('storage/') }}javascript:void(0)">
                ...
                <div class="tab-pane" id="control-sidebar-settings-tab">
                    <form method="post">
                        ...
                        <div class="form-group">
                            <label class="control-sidebar-subheading">
                                Delete chat history
                                <a href="{{ asset('storage/') }}javascript:void(0)" class="text-red pull-right"><i class="fa fa-trash-o"></i></a>
                            </label>
                        </div>
                        <!-- /.form-group -->
                    </form>
    ...
    <!-- jQuery UI 1.11.4 -->
    <script src="{{ asset('storage/bower_components/jquery-ui/jquery-ui.min.js') }}"></script>
    ...
    <!-- Morris.js charts -->
    <script src="{{ asset('storage/bower_components/raphael/raphael.min.js') }}"></script>
    <script src="{{ asset('storage/bower_components/morris.js/morris.min.js') }}"></script>
    <!-- Sparkline -->
    <script src="{{ asset('storage/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js') }}"></script>
    <!-- jvectormap -->
    ...
    <!-- jQuery Knob Chart -->
    <script src="{{ asset('storage/bower_components/jquery-knob/dist/jquery.knob.min.js') }}"></script>
    <!-- daterangepicker -->
    <script src="{{ asset('storage/bower_components/moment/min/moment.min.js') }}"></script>
    <script src="{{ asset('storage/bower_components/bootstrap-daterangepicker/daterangepicker.js') }}"></script>
    <!-- datepicker -->
    <script src="{{ asset('storage/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}"></script>
    <!-- Bootstrap WYSIHTML5 -->
    <script src="{{ asset('storage/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js') }}"></script>
    <!-- Slimscroll -->
